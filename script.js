...
function updateAuthUI() {
  ...
  if (isAuthed) {
    ...
    document.getElementById("logoutBtn").onclick = () => { isAuthed = false; sessionStorage.removeItem(AUTH_KEY); updateAuthUI(); updateSaveBanner(); render(); };
    document.getElementById("favBtnAuthed").onclick = openFavModal;
  } else {
    area.innerHTML = `<button class="btn btn-fav" id="favBtnGuest">❤️ Избранное<span class="fav-count">${favorites.length}</span></button>
